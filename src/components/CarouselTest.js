...
export default function CarouselTest() {
    ...
    const [startTouchTimes, setStartTouchTimes] = useState(0);
    const [endTouchTimes, setEndTouchTimes] = useState(0);
  ...
  const { startTouch, endTouch, moveTouch } = SwipeTest(
    currentIndex,
    handleIndexChange,
    startTouchTimes,
    setStartTouchTimes, 
  ...
  return (
    ...
    <div className="section"></div>
      ...
      <p>startTouchTimes: {startTouchTimes}</p>
        <p>endTouchTimes: {endTouchTimes}</p>
    </>
  );
}
