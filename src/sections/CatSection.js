...
<div className="section-text-container">
  ...
  <h4 className="section-text-content-headline">
    There is a photo with her and what seems to be planet Mars in the background. Real or fake?
  </h4>
  <p className="section-text-content">
    Good question. We can't say for sure whether it's photoshopped or real, 
    since none of us have been on Mars but "Mars Perseverance" logo is something to consider.
  ...
  wouldn't be able to modify the magnitude and affect their shadows
  </p>
  ...
  <h4 className="section-text-content-headline">A very active cat or a sleeper?</h4>
  <p className="section-text-content">I would say, it's an active sleeper</p>

  <h4 className="section-text-content-headline">Name and a favorite meal?</h4>
  <p className="section-text-content">Lil Puss. Anything that can be chewed</p>
</div>
